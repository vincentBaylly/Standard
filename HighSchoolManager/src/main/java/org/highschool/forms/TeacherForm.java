...
public class TeacherForm extends JInternalFrame {
    ...
    private void jButton1ActionPerformed(ActionEvent evt) {
        ...
        if (teacherService.create(new Teacher(id, jTextField1.getText(), jTextField2.getText(), "test@test.com", gender, 175, new Date()))) {
    ...
    private void jButton3ActionPerformed(ActionEvent evt) {
        ...
        //jComboBox1.getSelectedItem().toString()
        if (teacherService.update(new Teacher(id, jTextField1.getText(), jTextField2.getText(), "test@test.com", gender, 175, new Date()))) {
            JOptionPane.showMessageDialog(this, "Etudiant bien ajouter");
            clear();
            load();
        }
